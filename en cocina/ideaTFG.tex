...
Todos tenemos múltiples facetas en la vida. 
...
de estudios debe (o al menos puede) ser un trabajo que reúna una parte
considerable de los conocimientos alcanzados en los estudios. También debe (o
...
{\small{\begin{window}[0,r,\includegraphics[width=27mm]{JJM.jpg},] 
      ...
      el año 2004; también wikis y, últimamente, agregadores y otras
...
`Yes we can'. Después de unos cuantos años estudiando podremos
...
`Show me the money'. También somos defensores de la presentación del
...
`So proud of us'. En la mayoría de los trabajos de fin de
