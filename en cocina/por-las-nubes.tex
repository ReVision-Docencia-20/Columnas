...
% Yo dÃŒria algo asÃŒ como: En el eterno flujo y reflujo de la
% centralizaciÃ›n, descentralizaciÃ›n y vuelta a empezar ahora nos toca
% trabajar en la distancia. Es lo que nos han dicho que se llama la nube.
%
% O algo asÃŒ, lamento mi falta de fe.
  % OK, introducido como primera frase - JJ
...
\end{quote}
% En cierto modo esta forma de decirlo refuerza mi comentario anterior.
...
% La impedancia fruto de la falta de adaptacion puede ir en ambas direcciones.
...
tambi\'en Databeers o los Clubes lnet, 
%lnet ? .Net ?
d\'andoles alg\'un tipo de cobertura
legal
...
%
% O algo así
y, si es posible, integr\'andolos de alguna forma en el curr\'iculum
